...
PATH_IMAGE_ROOT = r"D:\CropSegmentation\data\AH\Proccesed"
...
PATH_OUTPUT = r"D:\CropSegmentation\data\AH\Training"
...
def prepare():
    ...
    for i in range(len(PATH_IMAGES_SPEC)):
        ...
        imgs_bd_subsets += subset_dts(img_bd, CHIP_SIZE, 100, 200)
